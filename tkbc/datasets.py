...
DATA_PATH = 'tkbc/data/' #pkg_resources.resource_filename('tkbc', 'data/')

class TemporalDataset(object):
    def __init__(self, name: str,path_save):
    ...
    def eval(
        ...
        for m in missing:
            ...
            ranks = model.get_ranking(q, self.to_skip[m], batch_size=500)#,x,y
